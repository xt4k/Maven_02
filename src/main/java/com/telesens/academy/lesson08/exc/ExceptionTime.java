...
import com.telesens.academy.lesson05.DateTime;
...
public class ExceptionTime {
    public static void main(String[] args) throws IllegalTimeException {
        ...
        System.out.println("-");
        try {
            System.out.println("check DateTime(-12, 12, 12) " + dateTime.checkTime(new DateTime(-12, 12, 12)));
        } catch (IllegalTimeException e) {
            System.out.println(e.getDetails());
        }
        try {
            System.out.println("check DateTime(23, 1, 60) " + dateTime.checkTime(new DateTime(23, 1, 60)));
        } catch (IllegalTimeException e) {
            System.out.println(e.getDetails());
        }
        try {
            System.out.println("check DateTime(24, 0, 0) " + dateTime.checkTime(new DateTime(24, 0, 0)));
        } catch (IllegalTimeException e) {
            System.out.println(e.getDetails());
        }
        try {
            System.out.println("check DateTime(23, 60, 0) " + dateTime.checkTime(new DateTime(23, 60, 0)));
        } catch (IllegalTimeException e) {
            System.out.println(e.getDetails());
        }
        System.out.println("-");
        try {
            System.out.println("check DateTime(1,0,-0) " + dateTime.checkTime(new DateTime(1, 0, -00)));
        } catch (IllegalTimeException e) {
            System.out.println(e.getDetails());
        }
        try {
            System.out.println("check DateTime(2,-0,17) " + dateTime.checkTime(new DateTime(2, -0, 17)));
        } catch (IllegalTimeException e) {
            System.out.println(e.getDetails());
        }
        System.out.println("-");
