...
public class DateTime extends Date {
    ...
    public String checkTime(DateTime dayTime) throws IllegalTimeException {
        ...
        if (dayTime.getMinutes() < 0)
            throw new IllegalTimeException("Minutes  number lower than 0: ", dayTime.getMinutes());
        if (dayTime.getMinutes() > 59)
            throw new IllegalTimeException("Minutes number exceeded 59: ", dayTime.getMinutes());
        if (dayTime.getSeconds() < 0)
            throw new IllegalTimeException("Minutes  number lower than 0: ", dayTime.getSeconds());
        if (dayTime.getSeconds() > 59)
            throw new IllegalTimeException("Minutes number exceeded 59: ", dayTime.getSeconds());
